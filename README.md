...
Затем соберите файлы статики командой '''python manage.py collectstatic'''. Вам также придётся повторять эту команду всякий раз, когда вы скачаете обновления, в которых будут изменены шаблоны проекта.
